...
var db = new sqlite3.Database(path.join(__dirname, "models", "db.sqlite"));
...
var crime_types = [
		...
		{name:"Obstruction of justice", tags:["other"]}
...
var buildings = [
	...
	{name:"Faculty Club", type:"Academic/Administrative", campus:"West", lat:35.996625, lon:-78.950737},
